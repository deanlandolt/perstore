...
var SchemaControlled = function(facetSchema, sourceClass, permissive){
	...
	var idTemplate;
	if(schemaLinks && Array.isArray(schemaLinks)){
		...
		return function wrap(source, transaction, wrapped, partial){
			return when(source, function(source){
				...
				function copyFromSource(){
					...
					// TODO instead do a Object.getOwnPropertyNames, Object.getOwnPropertyDescriptor
					Object.defineProperty(wrapped, "getMetadata", {
						value: source.getMetadata,
						enumerable: false,
						writable: true
					});
